...
export default function SearchSection() {
  ...
  return (
    <section className="py-20 px-6 relative overflow-hidden" style={{
      background: "linear-gradient(135deg, #0c1a2e 0%, #0ea5e9 50%, #3b82f6 100%)"
    }}>
      {/* Decorative circles */}
      <div className="absolute -top-24 -left-24 w-80 h-80 rounded-full bg-[#0ea5e9]/20 blur-3xl pointer-events-none" />
      <div className="absolute -bottom-24 -right-24 w-80 h-80 rounded-full bg-[#3b82f6]/20 blur-3xl pointer-events-none" />
      {/* Orange accent dot */}
      <div className="absolute top-10 right-1/4 w-4 h-4 rounded-full bg-[#0ea5e9] opacity-60 pointer-events-none" />
      ...
      <div className="max-w-[720px] mx-auto text-center text-white relative z-10">
        ...
        >
          ...
          <button
            type="submit"
            className="bg-[#0ea5e9] text-white px-8 py-4 rounded-full font-bold cursor-pointer hover:bg-[#2563eb] hover:-translate-y-0.5 hover:shadow-xl hover:shadow-[#0ea5e9]/40 transition-all text-sm whitespace-nowrap"
          >
            Search Now
          </button>
        </form>
