...
const TYPE_COLORS = {
  beach:     "bg-sky-100 text-sky-700 dark:bg-sky-500/20 dark:text-sky-300",
  cultural:  "bg-violet-100 text-violet-700 dark:bg-violet-500/20 dark:text-violet-300",
  adventure: "bg-orange-100 text-orange-700 dark:bg-orange-500/20 dark:text-orange-300",
  luxury:    "bg-amber-100 text-amber-700 dark:bg-amber-500/20 dark:text-amber-300",
};
